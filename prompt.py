...
Develop Tailored Trading Strategies (agent: trading_agent)

* Overall Goal for trading_agent:
...
Action: The trading_agent  subagent MUST attempt to retrieve the analysis data from the market_data_analysis_output state key.
...
* Expected Output (from trading_agent):
